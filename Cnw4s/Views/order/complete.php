...
<div class="page-title">
      <div class="wrapper"><h1 class="page-width">Thanks You Buyed Product from Trang Anh Kids Shop</h1></div>
    </div>
</div>
  <!--End Page Title-->
    ...
    <div class="row billing-fields">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 sm-margin-30px-bottom">
              <div class="create-ac-content bg-light-gray padding-20px-all">
                      <fieldset>
                          <h2 class="checkout-title mb-3">Order Complete</h2>
                          <div class="row">
                      ...
                      <div class="table-responsive-sm order-table">
                          <table class="bg-white table table-bordered table-hover text-center">
                              ...
                              <tfoot class="font-weight-600">
                                  <tr>
                                      <td colspan="4" class="text-right">Free Ship</td>
                                      <td></td>
                                  </tr>
                                  <tr>
