...
class CartController
{
    ...
    function list_cart()
    {
        ...
        if (isset($_SESSION['sanpham'])) {
            foreach ($_SESSION['sanpham'] as $value) {
                $count += $value['DonGia'] * $value['SoLuong'];
            }
        }
    ...
    function add_cart()
    {
        if (isset($_SESSION['login'])) {
            ...
            $km = $this->cart_model->get_km($data['MaKM']);
            ...
            if (isset($_SESSION['sanpham'][$id])) {
                ...
                $arr['ThanhTien'] = $arr['SoLuong'] * $arr["DonGia"] - $km['GiaTriKM'] * $arr['SoLuong'];
                $arr['KM'] = $km['GiaTriKM'];
                ...
                $arr['ThanhTien'] = $data['DonGia'] - $km['GiaTriKM'];
                $arr['KM'] = $km['GiaTriKM'];
    ...
    function update_cart()
    {
        ...
        $arr['SoLuong'] = $arr['SoLuong'] + 1;
        $arr['ThanhTien'] = $arr['SoLuong'] * $arr["DonGia"] - $arr['KM'] * $arr['SoLuong'];
